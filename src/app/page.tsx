        ...
        <section className="bg-white pt-16 pb-10">
          <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 text-center md:text-left md:pl-12">
              <h1 className="text-4xl font-bold font-heading text-brand-blue mb-4">
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-brand-blue font-serif">Built For Your Needs</h2>
            </div>
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-lg text-center">
                ...
                <h3 className="text-xl leading-6 font-bold text-brand-blue font-serif">Independent Compliance Monitoring</h3>
               ...
               <div className="bg-white p-8 rounded-lg shadow-lg text-center">
                ...
                <h3 className="text-xl leading-6 font-bold text-brand-blue font-serif">Risk Mitigation for Nonprofits</h3>
               ...
               <div className="bg-white p-8 rounded-lg shadow-lg text-center">
                ...
                <h3 className="text-xl leading-6 font-bold text-brand-blue font-serif">Support for Developers and Operators</h3>
               ...
               <div className="bg-white p-8 rounded-lg shadow-lg text-center">
                ...
                <h3 className="text-xl leading-6 font-bold text-brand-blue font-serif">Custom Consulting</h3>
